...
geometry_string="900x500+300+200"
...
#search box
Search_image=PhotoImage(file=r"C:\Users\sudee\Downloads\search.png")
my_image=Label(image=Search_image)
my_image.place(x=20,y=20)

textfield=tk.Entry(root,justify="center",width=17,font=("italic",22, "bold"),bg="#404040",border=0,fg="white")
textfield.place(x=50,y=40)
textfield.focus()

Search_icon=PhotoImage(file=r"C:\Users\sudee\Downloads\search_icon.png")
...
#logo
Logo_image=PhotoImage(file=r"C:\Users\sudee\Downloads\weather_logo.png")
logo=Label(image=Logo_image)
logo.place(x=150,y=100)

#bottom box
Frame_image=PhotoImage(file=r"C:\Users\sudee\Downloads\box.png")
